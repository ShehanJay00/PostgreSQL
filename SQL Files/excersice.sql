...
--The keyword 'per Facility' alerts that you have to use 'GROUP BY' clause
SELECT facid , SUM(slots) AS "Num of Slots"
FROM cd.bookings
...
--for filter n Aggregate function we have to use HAVING
...
--or you can the name for filter
--IN('Tenis court 1' , 'Tenis court 2')
